...
const resource = (placement: ResourcePlacement): ResourceNodeEntity => {
  ...
  return {
    ...
    visualVariant: placement.visualVariant,
...
export function createInitialEntities(): Record<string, Entity> {
  ...
  [
    ...
    portal('portal_road', 'town', 'Old River Road', 13, 4, 'road', { x: -8, y: 0, z: -1 }),
    portal('portal_plot', 'town', 'Housing Plot Ferry', -15, 13, 'housing', { x: -8, y: 0, z: 4 }),
    portal('portal_crypt', 'forest', 'Mine to Crypt', 7, -5, 'crypt', { x: -9, y: 0, z: 3 }),
    portal('portal_town_bank', 'bank', 'Town Door', 0, 6, 'town', { x: -8, y: 0, z: -1 }),
    portal('portal_town_smith', 'blacksmith', 'Town Door', -6, 5, 'town', { x: 6, y: 0, z: -2 }),
    portal('portal_town_forest', 'forest', 'Town Road', 0, 11, 'town', { x: 0, y: 0, z: 13 }),
    portal('portal_town_road', 'road', 'Town Gate', -8, 0, 'town', { x: 13, y: 0, z: 5 }),
    portal('portal_town_plot', 'housing', 'Town Ferry', -8, 5, 'town', { x: -14, y: 0, z: 12 }),
    portal('portal_forest_crypt', 'crypt', 'Forest Exit', -9, 4, 'forest', { x: 7, y: 0, z: -4 }),
    {
