...
const rawSpellDefs: Record<string, SpellDefinitionInput> = {
  ...
  recall: {
    ...
    description: 'Teleports Valen to the Briarbrook safe point.',
    effectType: 'recall',
    difficulty: 60,
  ...
  dispel_field: {
    ...
    category: 'Control',
    lineOfSight: true,
    targetFilters: ['field', 'trap', 'wall'],
    interruptible: true,
    friendlyMode: 'neutral',
    range: 7,
    reagents: [reagent('garlic'), reagent('mandrake_root'), reagent('sulfurous_ash')],
    wordsOfPower: 'An Grav',
    description: 'Removes temporary magical fields and stone walls near the target.',
