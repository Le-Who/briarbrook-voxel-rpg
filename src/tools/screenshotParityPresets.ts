...
const screenshotParityPresets: ScreenshotParityPreset[] = [
  ...
  preset('r2-road-combat', 'R2', 'Old River Road Combat', 'road', { x: 0, y: 0, z: -1 }, 'dusk', ['inventory', 'status'], { zoom: 17, offset: { x: 8.8, y: 10.0, z: 8.8 } }, { selectedTargetId: 'enemy_bandit_1' }),
  preset('r3-crypt-combat', 'R3', 'Forgotten Crypt Combat', 'crypt', { x: -2, y: 0, z: 1 }, 'day', ['inventory', 'status'], { zoom: 15.2, offset: { x: 7.3, y: 8.7, z: 7.3 } }, { selectedTargetId: 'enemy_skel_1' }),
  preset('r4-forest-gathering', 'R4', 'Greymont Forest Gathering', 'forest', { x: 9.8, y: 0, z: 2.8 }, 'day', ['inventory', 'status'], { zoom: 16.8, offset: { x: 8.6, y: 10.2, z: 8.6 } }),
  ...
  preset('r7-housing-build', 'R7', 'Player Plot Build Mode', 'housing', { x: -3, y: 0, z: 1 }, 'day', ['inventory', 'status', 'build'], { zoom: 17.2, offset: { x: 8.6, y: 10.2, z: 8.6 } }, { selectedBuildPieceId: 'small_chest', selectedBuildCategory: 'Storage' }),
